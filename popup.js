(function(){
  var apps_urls = {
    png: "http://www.offidocs.com/edit-openofficewriter.php?fileurl=newfileoriginal"
  };
  ...
  document.getElementById('status').innerText = `Using OpenOffice Writer online for Word documents`;
